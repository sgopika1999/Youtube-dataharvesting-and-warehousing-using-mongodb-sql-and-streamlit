...
#insert=channelinfo("UCueYcgdqos0_PzNOq81zAFg")
...
if question=="1. What are the names of all the videos and their corresponding channels?":
        ...
        question3='''SELECT view_count as views,channel_name as channelnames,video_name as videoname from videos 
                where view_count is not null order by views desc limit 10'''
        mycursor.execute(question3)
        mydb.commit()
        t3=mycursor.fetchall()
        df3=pd.DataFrame(t3,columns=["views","channelnames","videoname"])
        st.write(df3)
        ...
        question5='''SELECT like_count as likes,channel_name as channelnames,video_name as videoname from videos 
        ...
        question8='''SELECT channel_name as channelnames,published_at as publisheddate,video_name as videoname from videos
        ...
        question9="SELECT channel_name as channelnames, AVG(duration) as average_duration from videos group by channel_name" 
        mycursor.execute(question9)
        mydb.commit()
        t9=mycursor.fetchall()
        df9=pd.DataFrame(t9,columns=["average_duration","channelnames"])
        ...
        question10='''SELECT video_name as videoname,comment_count as comments,channel_name as channelnames from videos where comment_count is not null
